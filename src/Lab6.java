...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
	 ...
	 public void Piramiad(GL2 gl2, int iloscWierzcholkow)
	 {
// zmienne
	    	double promien = 3;
	    	float x=0, z=0;
		    double kat = 0;
		    double inkrementacjaKata = 2 * Math.PI / iloscWierzcholkow;
// zmienne
...
// ustawienie koloru void glMaterialfv (int side, int property, float * valueArray)
	            gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[i], 1);
